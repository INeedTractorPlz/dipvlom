...
struct triangle_t
{
    ...
    state_vector normal;
    triangle_t(state_vector vertex_1, state_vector vertex_2, state_vector vertex_3) : vertex_1(vertex_1), vertex_2(vertex_2), vertex_3(vertex_3),
...
struct Integrator_t
{
    ...
    Integrator_t(unsigned &current, Body_t &Body, Force_t &Force,
                 ...
                 std::vector<Body_position_t> *Rigit_body_orbit = NULL, tuple_t *fandf = NULL) : current(current), Body(Body), Force(Force)
    {
...
{
    return Body_position_t(Body_left.center + Body_right.center, Body_left.center_velocity + Body_right.center_velocity, Body_left.Euler_angles.angles + Body_right.Euler_angles.angles,
...
{
    return Body_left = Body_position_t(Body_left.center + Body_right.center, Body_left.center_velocity + Body_right.center_velocity, Body_left.Euler_angles.angles + Body_right.Euler_angles.angles,
                                       Body_left.angular_velocity + Body_right.angular_velocity);
}
